...
<body id="steven_body">
	...
	<?php
			...
			echo 
			'
		<img class="boxy" style="width:740px;height:412px;margin-left:100px;" class="pilt" src="small/badcat2.jpg" alt="Bad Cat Lynx 50"  />
		<p class="role"> Bad Cat Lynx - 50 Watts</p>
		<p class="bio">
		The baddest of the bad! This is our no holds barred, hard rock tone machine. When we set out to design the Lynx we wanted to build the best high gain amplifier on the market. We brought everything to the table and all the tricks we have learned over the years.
		<br><br>
